<template>
  <div class="campaigns-tab dashboard-tab">
    <div class="row">
      <div class="col-md-12">
...
import FieldsDefCampaign from 'vuestic-components/vuestic-datatable/data/fields-definition-campaign'
...
export default {
  ...
  data () {
    return {
      ...
      sortFunctions: FieldsDefCampaign.sortFunctions,
      paginationPath: '',
